...
import { arrayMethods } from './array' // __proto__为Array.prototype的对象，可以访问到数组的所有方法
import {
  def, // 定义对象属性的枚举特性
  warn,
  hasOwn,
  hasProto, // 判断对象中有没有__proto__属性
  isObject,
  isPlainObject,
  isValidArrayIndex,
  isServerRendering
...
const arrayKeys = Object.getOwnPropertyNames(arrayMethods) // 取得所有对象上面的属性键名
...
export function observe (value: any, asRootData: ?boolean): Observer | void {
  if (!isObject(value) || value instanceof VNode) { // value必须是Object类型，且不能是VNode实例
    return
  }
