...
function transformNode (el: ASTElement, options: CompilerOptions) {
  ...
  const staticClass = getAndRemoveAttr(el, 'class') // 从astElement中获取class属性
  ...
  const classBinding = getBindingAttr(el, 'class', false /* getStatic */) // 从astElement中获取绑定class属性 :class、v-bind:class
  if (classBinding) {
